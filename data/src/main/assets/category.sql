...
CREATE TABLE IF NOT EXISTS categories(uid INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name TEXT NOT NULL, type TEXT NOT NULL, icon TEXT NOT NULL, isNeed INTEGER DEFAULT NULL);
